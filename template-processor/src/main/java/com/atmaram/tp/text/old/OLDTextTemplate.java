...
public class OLDTextTemplate {
    List<Object> blocks;
    public List<Object> getBlocks() {
        return blocks;
    }
    public static OLDTextTemplate parse(String text) throws TemplateParseException {
        OLDTextTemplate textTemplate=new OLDTextTemplate();
        ...
        while(i<text.length()){
            if(text.length()>i+1 && text.substring(i,i+2).equals("${"))
            {
                ...
                textLoop.inner_template=OLDTextTemplate.parse(strInnerTemplate);
        ...
        for(int i=0;i<blocks.size();i++){
            ...
            if(oBlock instanceof String){
                ...
                for (Object inner_data:
                    ...
                    try {
                        OLDTextTemplate newTextTemplate=OLDTextTemplate.parse(inner);
    ...
    public List<Variable> getVariables(){
        ...
        for (Object oValue:
            ...
            if(oValue instanceof String){
                ...
                OLDTextTemplate inner_tt=tlValue.inner_template;
